---
title: "[Co-Working with AI for Public Sector Employees]{.yellow}"
subtitle: "Workshop with GCUF Adminstration Staff"
author: "Zahid Asghar"
date: "2025-05-15"
format:
  revealjs:
...
::: r-fit-text
### AI in University Offices: From Paperwork to Productivity

> From overloaded staff to optimized systems—AI is the silent reformer.
:::
...
**Purpose:** - Understand and summarize what’s already there.
...
**Definition:** - Focuses on creating new content by learning from existing patterns.

**Purpose:** - To generate something new—whether it's text, art, or even videos.
...
![](images/race_tech_edu.png){.r-stretch}
...
::::: columns
::: {.column width="50%"}
![](images/interactive_learning.webp)
:::

::: {.column width="50%"}
![](images/interactive_learning1.webp)
:::
:::::
...
:::::::: columns
::: {.column width="20%"}
![](images/book1.jpeg){.stretch}
:::

::: {.column width="20%"}
![](images/book2.jpeg){.stretch}
:::

::: {.column width="20%"}
![](images/book3.jpeg){.stretch}
:::

::: {.column width="20%"}
![](images/book4.jpeg){.stretch}
:::

::: {.column width="20%"}
![](images/book5.jpeg){.stretch}
:::
::::::::
...
-   **LinkedIn:** <https://www.linkedin.com/in/zahid-asghar/>

-   **Twitter:** [\@Zahadasghar](https://twitter.com/Zahadasghar)

-   **YouTube:** <https://www.youtube.com/c/ZahidAsghar>
